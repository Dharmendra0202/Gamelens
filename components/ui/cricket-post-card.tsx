...
export function CricketPostCard({
  post,
  onLike,
  onComment,
  onShare,
  onSave,
}: CricketPostCardProps) {
  return (
    <View style={styles.postCard}>
      ...
      <View style={styles.postHeader}>
        <View
          style={[
            ...
            { borderColor: post.verified ? "#B71C1C" : "transparent" },
          ]}
        >
      ...
      {post.hasMedia && (
        <View style={styles.postMediaBox}>
          <LinearGradient
            colors={["#8B0000", "#8B0000", "#B91C1C"]}
            style={styles.postMediaGradient}
          >
            <Ionicons
              name="images-outline"
              size={36}
      ...
      <View style={styles.postStatsRow}>
        <View style={styles.postStatsLeft}>
          <View style={styles.likeIconRow}>
            ...
            <View
              style={[
                styles.likeIconBg,
                { backgroundColor: "#8B0000", marginLeft: -4 },
              ]}
            >
        ...
        <Text style={styles.postStatsTxt}>
      ...
      <View style={styles.postActionsRow}>
        ...
        >
          ...
          />
          <Text
            style={[styles.postActionTxt, post.liked && { color: "#EF4444" }]}
          >
            Like
          </Text>
        </TouchableOpacity>
