...
const styles = StyleSheet.create({
  ...
  header: {
    ...
    paddingTop: HEADER_PADDING_TOP,
    paddingBottom: HEADER_PADDING_BOTTOM + 2,
    shadowColor: "#000",
  ...
  headerTitleOrange: { color: "#FFB74D" },
  headerRight: { flexDirection: "row", gap: 0, marginRight: -4 },
  iconButton: { 
    padding: 6,
    marginLeft: 0,
  },
  ...
  // Community Feed
  feedSection: { marginTop: 10, backgroundColor: "#FAFAFA", paddingBottom: 20 },
  feedHeaderRow: {
    flexDirection: "row",
    justifyContent: "space-between",
    alignItems: "center",
  ...
  feedSubtitle: { fontSize: 13, color: "#757575", marginTop: 3, fontWeight: "500" },
  feedFilterBtn: {
    flexDirection: "row",
    alignItems: "center",
    gap: 6,
  ...
  feedFilterTxt: { fontSize: 13, fontWeight: "700", color: "#B71C1C" },
  storiesRow: {
    paddingHorizontal: 12,
    paddingTop: 10,
    paddingBottom: 6,
  ...
  storyAvatarInitials: { fontSize: 18, fontWeight: "800", color: "#FFF" },
  storyName: {
    fontSize: 11,
    fontWeight: "600",
    color: "#424242",
  ...
  createPostInitialsSmall: { fontSize: 14, fontWeight: "800", color: "#FFF" },
  createPostInputFake: {
    flex: 1,
  ...
  createPostPlaceholderTxt: { fontSize: 14, color: "#999", fontWeight: "500" },
  createPostActions: {
    flexDirection: "row",
    alignItems: "center",
    marginLeft: 10,
  ...
  feedTabTxt: { fontSize: 13, fontWeight: "700", color: "#666" },
