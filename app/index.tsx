...
const CRICKET_HERO_IMAGE =
  "https://images.unsplash.com/photo-1540747913346-19e32dc3e97e?w=900&h=900&fit=crop";
const CRICKET_GEAR_IMAGE =
  "https://images.unsplash.com/photo-1531415074968-036ba1b575da?w=500&h=500&fit=crop";
  ...
  return (
    <Animated.View style={[splashStyles.root, { opacity: screenOpacity }]}>
      ...
      >
        ...
        <Animated.View
          style={[splashStyles.wordUnderline, { opacity: wordOpacity }]}
        />
      </Animated.View>
        ...
        >
          ...
          >
            ...
            <View style={styles.card}>
              ...
              <View
                style={[styles.inputWrap, passFocus && styles.inputWrapFocused]}
              >
                <Ionicons
              ...
              <TouchableOpacity
                style={[
                  styles.loginButton,
                  loginPressed && styles.loginButtonPressed,
                ]}
                onPress={handleLogin}
          ...
          <View style={styles.heroBanner}>
            ...
            <View style={styles.heroCopy}>
              ...
              <Text style={styles.heroText}>
                Create your cricket profile and get started.
              </Text>
            </View>
          </View>
            ...
            {[
              ...
              <View key={i} style={styles.inputWrap}>
                ...
                <TextInput
                  ...
                  autoCapitalize={
                    field.secure || field.type === "email-address"
                      ? "none"
                      : "words"
                  }
